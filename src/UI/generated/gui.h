...
class BrowseCardsScreen : public wxFrame
{
	...
	protected:
		...
		wxButton* BrowseCardsShowEditBtn;
		wxButton* BrowseCardsDeleteBtn;

		// Virtual event handlers, override them in your derived class
		virtual void OnCardSelected( wxListEvent& event ) { event.Skip(); }
		virtual void OnBrowseCardsShowEditClicked( wxCommandEvent& event ) { event.Skip(); }
		virtual void OnBrowseCardsDeleteClicked( wxCommandEvent& event ) { event.Skip(); }


	public:

		BrowseCardsScreen( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 694,607 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
